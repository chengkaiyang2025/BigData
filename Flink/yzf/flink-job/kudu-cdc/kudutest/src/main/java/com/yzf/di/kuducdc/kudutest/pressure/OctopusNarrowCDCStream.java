 ...
 * 4、sink算子写入到kudu
 */
public class OctopusNarrowCDCStream {
    ...
    public static ObjectNode JsonSchemaValidator(ObjectNode data){
        ...
        if (data.get("fetch_data_time") == null)  data.put("fetch_data_time","NULL");
    ...
    public static void main(String[] args) throws Exception {
        ...
        // --kudu_table octopus_ods.octopus_qushu_table_narrow_re1_202106
        String KUDU_TABLE = tool.get("kudu_table","impala::octopus_ods.octopus_qushu_table_narrow_re1_202106");
