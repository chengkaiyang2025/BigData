...
//            String ex = ExceptionUtil.stacktraceToString(e);
    ...
    public static String getDesc(RequestCnt requestCnt){
        return String.format("云帐房代帐系统帐号：%s，于%s点，极其频繁访问页面: %s，疑似存在爬虫行为",
                requestCnt.getUserName(),
                requestCnt.getLastTime(),
                requestCnt.getRequest_web_page());
    }
